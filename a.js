...
function resetONhapCuoc() {
  let luaChon = ["bau", "cua", "tom", "ca", "ga", "huou"];
  luaChon.forEach((chon) => {
    let oNhap = document.getElementById(`bet-amount-${chon}`);
    oNhap.value = ""; // Reset về trống
    oNhap.placeholder = "Nhập số tiền"; // Đưa về trạng thái ban đầu
  });
}
